...
search = dict(
    ...
    manually_apply_for_jobs = True, # Whether or not to run the manual application portion of the script
    ...
    search_for_jobs = True, # Whether or not to run the search portion of the script
